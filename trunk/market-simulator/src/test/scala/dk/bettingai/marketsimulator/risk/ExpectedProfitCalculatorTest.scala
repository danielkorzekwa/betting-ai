...
class ExpectedProfitCalculatorTest {
	...
	@Test def testCalculateOneBackBetProbabilityNotChanged {
		...
		val expectedProfit = ExpectedProfitCalculator.calculate(bets, probabilities,0)
		assertEquals(0,expectedProfit.marketExpectedProfit,0)
	...
	@Test def testCalculateOneBackBetProbabilityNotChangedWithCommission {
		...
		val expectedProfit = ExpectedProfitCalculator.calculate(bets, probabilities,0.03)
