...
class MarketEventCalculatorTest {
	...
	@Test def testTradedVolumeAreTheSameNewMarketPricesAreAvailable {
		val newRunnerPrices =  new RunnerPrice(1.85,20,0) :: new RunnerPrice(1.87,45,0) :: new RunnerPrice(1.9,12,0) :: new RunnerPrice(1.93,0,56) :: new RunnerPrice(1.95,0,23) :: new RunnerPrice(2.0,0,30):: Nil
		val newTradedVolume = new PriceTradedVolume(1.84,100) :: new PriceTradedVolume(1.86,200) :: Nil

		val previousRunnerPrices = new RunnerPrice(1.9,10,0) :: new RunnerPrice(1.87,45,0) :: new RunnerPrice(1.93,0,56) :: new RunnerPrice(1.95,0,20) :: Nil
		val previousTradedVolume = new PriceTradedVolume(1.84,100) :: new PriceTradedVolume(1.86,200) :: Nil
