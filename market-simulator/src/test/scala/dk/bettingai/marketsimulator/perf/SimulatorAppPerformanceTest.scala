...
class SimulatorAppPerformanceTest {
	...
	@Test def testRealMarketDataAndNopTrader() {
		...
		SimulatorApp.main(Array("htmlReportDir=./target","marketDataDir=src/test/resources/marketDataPerfTest","traderImpl=dk.bettingai.marketsimulator.trader.NopTrader"),new PrintStream(consoleStream))
