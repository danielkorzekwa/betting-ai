...
class SimulatorAppTest {
	...
	@Test def testSimpleTraderAndPlaceBetEvent() {
		...
		assertTrue("Wrong output:\n" + new String(consoleStream.toByteArray),new String(consoleStream.toByteArray).contains("TotalExpectedProfit=-0.65 Wealth=-0.65 TotalMatchedBets=3 TotalUnmachedBets=1"))
	...
	@Test def testSimpleTraderAndBetsForTwoMarkets() {
		...
		assertTrue("Wrong output:\n" + new String(consoleStream.toByteArray),new String(consoleStream.toByteArray).contains("TotalExpectedProfit=1.56 Wealth=1.55 TotalMatchedBets=3 TotalUnmachedBets=3"))
	}
	...
	@Test def testSimpleTraderAndRealData() {
		...
		assertTrue("Wrong output:\n" + new String(consoleStream.toByteArray),new String(consoleStream.toByteArray).contains("TotalExpectedProfit=-363.24 Wealth=-1269.83 TotalMatchedBets=12879 TotalUnmachedBets=1096"))
	}
}
