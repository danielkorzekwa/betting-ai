...
class UserBetsTest {
  ...
  @Test
  def initialBets {
    val initialBets = Bet(100, 1000, 3, 2.2, BACK, U, 1, 11, 1000,None) :: Bet(100, 1000, 4, 2.4, BACK, M, 1, 11, 1000,Option(2500)) :: Bet(100, 1000, 3, 2.2, BACK, M, 1, 11, 1000,Option(2000)) :: Nil
  ...
  def oneBetPlaced {
    val userBets = UserBets(Nil)
    userBets.betPlaced(new Bet(100, 1000, 10, 2.2, BACK, U, 1, 11, 1500,None))
  ...
  def oneBetPlacedandFullyMatched {
    ...
    val userBets = UserBets(Nil)
    userBets.betPlaced(Bet(100, 1000, 10, 2.2, BACK, U, 1, 11, 1000,None))
    userBets.betMatched(Bet(100, 1000, 10, 2.2, BACK, M, 1, 11, 1000,Option(2000)))
  ...
  def oneBetPlacedandFullyMatchedWithTwoPortions {
    ...
    val userBets = UserBets(Nil)
    userBets.betPlaced(Bet(100, 1000, 10, 2.2, BACK, U, 1, 11, 1000,None))
    userBets.betMatched(Bet(100, 1000, 4, 2.4, BACK, M, 1, 11, 1000,Option(2500)))
    userBets.betMatched(Bet(100, 1000, 6, 2.2, BACK, M, 1, 11, 1000,Option(2000)))
  ...
  def oneBetPlacedandPartiallyMatchedWithTwoPortions {
    ...
    userBets.betPlaced(Bet(100, 1000, 10, 2.2, BACK, U, 1, 11, 1000,None))
    userBets.betMatched(Bet(100, 1000, 4, 2.4, BACK, M, 1, 11, 1000,Option(2500)))
    userBets.betMatched(Bet(100, 1000, 3, 2.2, BACK, M, 1, 11, 1000,Option(2000)))
